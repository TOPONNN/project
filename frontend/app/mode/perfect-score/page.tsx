        ...
        >
          ...
          {mounted && (
            <motion.button
              ...
              className="px-12 py-4 rounded-full bg-[#FFD700] text-black font-bold text-lg disabled:opacity-50 flex items-center justify-center gap-2 mx-auto"
            >
              {loading ? (
                <>
