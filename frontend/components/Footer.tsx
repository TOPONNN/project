...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-white/10 py-12 px-6 md:px-20">
      <RevealAnimation className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-8 text-sm text-gray-400">
           <button onClick={() => scrollTo('skills')} className="hover:text-white transition-colors">Features</button>
